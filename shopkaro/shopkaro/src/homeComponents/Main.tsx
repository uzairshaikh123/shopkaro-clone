        ...
        {DataMain.map((el) => (
          <GridItem  backgroundColor="#fff" >
            <Stack>
             ...
             <Image  src={el.img} width="100%" height="90%"  alt={el.desc} /></Stack>
             <Flex>
              
             </Flex>
             <Flex>
              <Stack borderRadius="50%" border="1px solid" padding="7px"> <BsHeart color="red"  fontSize="30px" /></Stack>
              <Stack borderRadius="50%" border="1px solid" padding="7px"> <BsWhatsapp color="green"  fontSize="30px" /> </Stack>
             </Flex>
